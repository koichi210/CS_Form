...
namespace ToyingData.Tests
{
    ...
    internal static class FormReflection
    {
        ...
        /// <summary>CheckBox / RadioButton のどちらでも Checked プロパティを設定できる。</summary>
        public static void SetChecked(object form, string fieldName, bool value)
        {
            Control control = GetControl(form, fieldName);
            PropertyInfo prop = control.GetType().GetProperty("Checked");
