...
namespace EventRecorder.Windows.Simulation
{
    /// <summary>
    ...
    public static class InputSimulator
    {
        ...
        public static void AddMouseInput(ref System.Collections.Generic.List<Input> inputs, MouseStroke flag, int data, Boolean absolute, int x, int y)
        {
        ...
        /// <param name="x">水平位置または移動量</param>
        /// <param name="y">垂直位置または移動量</param>
        public static void AddMouseInput(ref System.Collections.Generic.List<Input> inputs, System.Collections.Generic.List<MouseStroke> flags, int data, Boolean absolute, int x, int y)
        {
            if (flags == null)
            {
                return;
