namespace EventRecorder
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dataGridView_Events.Size = new System.Drawing.Size(404, 180);
            ...
            this.button_Record.Location = new System.Drawing.Point(6, 206);
            ...
            this.button_Clear.Location = new System.Drawing.Point(92, 206);
            ...
            // label_Loop
            //
            // 「ループ回数」は単発再生の回数と、プレイリストの「全体ループ」を兼ねる共通項目。
            // どちらのグループボックスにも属さず、再生ボタンのすぐ横に置く
            ...
            // button_Play
            //
            // 単発再生の「再生」とプレイリストの「実行」を統合したボタン。意味が同じなので1つにまとめ、
            // どちらのグループボックスにも属さず一番下に置く。動作(単発/プレイリストどちらを再生するか)は
            // ラジオボタンで選択中のモードに従う
            ...
            // 別途「設定値読込」ボタンは不要(そのぶんプルダウンを広く使う)。
            // ウィンドウを横に広げた時、保存ボタンとの間を自然に埋められるよう左右(Left&Right)で伸縮させる
            ...
            // button_ProfileSave
            //
            // グリッドの右端に位置を揃え、ウィンドウ幅が変わってもその右端に追従するようRightアンカーにする
            ...
            // label_MousePos
            //
            // 起動中ずっとマウスカーソルの座標を表示しておく。右上に置き、ウィンドウ幅が変わっても
            // そこに留まるようTop+Rightアンカーにする
            ...
            this.radioButton_Playback.Size = new System.Drawing.Size(89, 16);
            ...
            this.radioButton_Record.Size = new System.Drawing.Size(65, 16);
            ...
            // splitContainer_Main
            //
            // タブだと「記録・再生」「プレイリスト」のどちらか一方しか見えず、
            // プレイリスト再生中に「今どのファイルを再生しているか」と「実際にどのイベントが
            // 実行されているか」を同時に見たいという要望から、タブ方式をやめて上下分割表示にした。
            // 上段=プレイバック(プレイリスト)、下段=レコード(記録・単発再生用のイベント一覧)
            // 既定の細い境界線だとドラッグできる場所だと気づきにくいので、太くして色も付ける
            this.splitContainer_Main.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom)
            | System.Windows.Forms.AnchorStyles.Left)
            | System.Windows.Forms.AnchorStyles.Right)));
            this.splitContainer_Main.BackColor = System.Drawing.Color.SteelBlue;
            // ダイアログの左右端ぴったりだとグループボックスの枠線が見えないため、
            // 左右5pxずつ内側にする
            this.splitContainer_Main.Location = new System.Drawing.Point(5, 28);
            this.splitContainer_Main.Name = "splitContainer_Main";
            this.splitContainer_Main.Orientation = System.Windows.Forms.Orientation.Horizontal;
            this.splitContainer_Main.SplitterWidth = 4;
            //
            // splitContainer_Main.Panel1(上段: プレイバック)
            //
            // BackColorは子コントロールに継承されるため、SplitContainer本体の色(スプリッター部分にのみ
            // 使いたい)がグループボックスの背景にまで及ばないよう、各パネルには既定の背景色を明示しておく
            ...
            //
            // splitContainer_Main.Panel2(下段: レコード)
            //
            ...
            this.groupBox_Playback.Size = new System.Drawing.Size(422, 254);
            ...
            this.groupBox_Record.Size = new System.Drawing.Size(422, 258);
